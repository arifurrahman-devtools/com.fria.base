...
<root>
  ...
  ├── Editor
  │   ├── Wingsoftheblackbird.Base.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Wingsoftheblackbird.Base.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Wingsoftheblackbird.Base.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Wingsoftheblackbird.Base.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Wingsoftheblackbird.Base`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package base Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Wingsoftheblackbird.Base.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Wingsoftheblackbird.Base.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Wingsoftheblackbird.Base.Editor.Tests.asmdef`

  `Tests/Runtime/Wingsoftheblackbird.Base.Tests.asmdef`
...
Use the `Documentations~/base.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
