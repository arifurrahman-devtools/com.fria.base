...
<root>
  ...
  ├── Editor
  │   ├── Friarchy.Core.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Friarchy.Core.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Friarchy.Core.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Friarchy.Core.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Friarchy.Core`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package core Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Friarchy.Core.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Friarchy.Core.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Friarchy.Core.Editor.Tests.asmdef`

  `Tests/Runtime/Friarchy.Core.Tests.asmdef`
...
Use the `Documentations~/core.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
